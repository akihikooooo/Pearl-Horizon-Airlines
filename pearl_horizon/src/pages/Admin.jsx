    ...
    return(
        <div>
            <div id="topbar" className="flex items-center justify-end p-4">
                {/* <input type="text" placeholder="Search airports..." className="m-2"/> */}
                    <button className="bg-green-600 text-white p-2 rounded-md">Add Flight</button>
                </div>
            <div id="table" className="w-full">
                    ...
                    <div className="table-row">
                        ...
                        <div className="table-cell"><button className="flex justify-center items-center text-white bg-red-500 p-2 rounded-md"><span className="material-symbols-outlined">delete</span>Delete</button></div>
                    </div>
                </div>
            </div>
    )
}
function AddAirport({ newAirportSubmit }) {
    return (
        <div>
