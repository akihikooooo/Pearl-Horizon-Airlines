    ...
    return (
        <div id="home">
            <div id="hero" className="flex flex-col pt-14  lg:flex-row items-center justify-between bg-blue-100">
                ...
                {/* Flight search form */}
                <div id="form" className="m-2 lg:w-1/2 flex flex-col items-center justify-center p-8">
                    <h1 className="font-extrabold text-2xl text-left w-full mb-4">Book a Flight</h1>
                    {/* Form */}
                    <SearchFlights/>
                </div>
            </div>
            <div id="requirements" className="flex justify-center items-center gap-8 p-8 w-full">
                ...
                <div id="req-text" className="flex flex-col w-1/2">
                    ...
                    <NavLink
                        to="requirements"
                        className=" p-2 w-1/2 font-blue-500 border border-blue-500 rounded hover:bg-blue-500 hover:text-white transition duration-300"
                    >
...
function SearchFlights() {
    ...
    console.log(backend)
    return (
        <form className="flex flex-col justify-center gap-4 w-full h-full" onSubmit={backend.searchFlights}>
            <div id="radios" className="w-full flex">
                <input type="radio" id="oneway" name="trip" value="oneway" className="hidden peer/oneway" />
                <label
                    htmlFor="oneway"
                ...
                <input type="radio" id="roundtrip" name="trip" value="roundtrip" className="hidden peer/roundtrip" />
                <label
                    htmlFor="roundtrip"
            ...
            <div className="flex gap-4">
                <input type="text" placeholder="From" className="border p-2 rounded w-1/2" />
                <input type="text" placeholder="To" className="border p-2 rounded w-1/2" />
            </div>
